		        ...
		        success: function (data) {
		        	...
		        	$.each(subtables, function(index, sub){
		        		...
		        		$.each(fields, function(index, value){
							...
							conText += "<div class=\"form-check form-check-inline\"><input class=\"form-check-input\" type=\"radio\" name=\"radio"+index+"\" id=\"radio"+index+"\" value=\"fixed\" checked><label class=\"form-check-label\" for=\"radio"+index+"\">fixed</label></div>";
							conText += "<div class=\"form-check form-check-inline\"><input class=\"form-check-input\" type=\"radio\" name=\"radio"+index+"\" id=\"radio"+index+"\" value=\"random\"><label class=\"form-check-label\" for=\"radio"+index+"\">random</label></div>";
							conText += "<div class=\"form-check form-check-inline\"><input class=\"form-check-input\" type=\"radio\" name=\"radio"+index+"\" id=\"radio"+index+"\" value=\"auto-growth\"><label class=\"form-check-label\" for=\"radio"+index+"\">auto-growth</label></div>";
							conText += "<div class=\"input-group mb-3\"><div class=\"input-group-prepend\"><span class=\"input-group-text\" id=\"basic-addon1\">Prefix</span></div><input type=\"text\" class=\"form-control\" aria-describedby=\"basic-addon1\" id=\"pre"+index+"\"></div>";
							conText += "<div class=\"input-group mb-3\"><div class=\"input-group-prepend\"><span class=\"input-group-text\" id=\"basic-addon1\">Range Begin</span></div><input type=\"text\" class=\"form-control\" aria-describedby=\"basic-addon1\" id=\"rangeBegin"+index+"\"></div>";
							conText += "<div class=\"input-group mb-3\"><div class=\"input-group-prepend\"><span class=\"input-group-text\" id=\"basic-addon1\">Range End</span></div><input type=\"text\" class=\"form-control\" aria-describedby=\"basic-addon1\" id=\"rangeEnd"+index+"\"></div>";
							conText += "</br>";
		        		});
		        		conText += "</div></div></div>";
		        	});
